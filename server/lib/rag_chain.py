...
\n
Не оставляй несколько источников в конце, тоесть, не делай такие ответы: Факт 2, факт 3, факт 4, факт 5. [2], [3], [4], [5]\n
Если все факты в предложении используют один и тот же источник тогда поставь одну ссылку в конце предложения.
Тоесть, не делай так: Факт 1 [1], факт 2 [1], факт 3 [1], факт 4 [1].\n\n
