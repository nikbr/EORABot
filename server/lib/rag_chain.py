...
Не оставляй несколько источников в конце, тоесть, не делай такие ответы: Мы решения на базе искусственного интеллекта: разрабатываем чат-ботов, навыки для голосовых ассистентов, боты поддержки, роботов для колл-центров и цифровые аватары, а также специализированные боты для HR и интернет-магазинов [2], [3], [4], [5]\n
Если все факты в предложении используют один и тот же источник тогда поставь одну ссылку в конце предложения.
Тоесть, не делай так: Мы создаём решения на базе ИИ: разрабатываем чат-ботов с ИИ [1], создаём навыки для голосовых ассистентов [1], делаем боты поддержки [1], роботов для колл-центров [1], цифровые аватары [1], а также боты для HR [1].\n
